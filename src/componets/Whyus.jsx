    ...
    <div className="max-w-6xl mx-auto px-4 py-10 text-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="flex flex-col items-center">
          <img src="1.png" alt="We come to you" className="w-8 h-8 mb-4" />
        ...
        <div className="flex flex-col items-center">
          <img src="2.png" alt="Expert advice" className="w-8 h-8 mb-4" />
        ...
        <div className="flex flex-col items-center">
          <img src="3.png" alt="Affordable pricing" className="w-8 h-8 mb-4" />
        ...
        <div className="flex flex-col items-center">
          <img src="4.png" alt="Local and trusted" className="w-8 h-8 mb-4" />
